...
1. The install script takes the same parameters as the core opencrowbar install.sh script.  That can be found [here](https://github.com/opencrowbar/core/blob/master/doc/deployment-guide/Install-CentOS-RHEL-6.6-AdminNode.md).

2. `wget --no-check-certificate -O - https://raw.githubusercontent.com/rackn/packstack/master/tools/packstack-install.sh | source /dev/stdin --develop`
